...
public class JsoupUtilsTest {
    ...
    private static final String XML = new StringBuilder()
        ...
        .append("<doc>")
            ...
            .append("</table>")
            .append("<div class=\"project-group\">")
            .append("<h1 class=\"project-title\">project title</h1>")
            .append("<p class=\"project-status\">completed</p>")
            .append("</div>")
        .append("</doc>")
    .toString();
    ...
    @Test
    public final void getStringValueByClassTest() {
        Element projectGroup = xml.getElementsByClass("project-group").first();
        Assert.assertEquals("completed", JsoupUtils.getStringValueByClass(projectGroup, "project-status"));
        Assert.assertEquals("project title", JsoupUtils.getStringValueByClass(projectGroup, "project-title"));
    }
}
