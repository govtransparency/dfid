...
public final class JsoupUtils {
    ...
    /**
     * returns the string value (data) from a html element by it's classname
     * 
     * @param node the Element where the item with class has to be searched
     * @param className the name of the class
     * @return null or the string value/data of the element
     */
    public static String getStringValueByClass(final Element node, final String className) {
        Element resultElement = node.getElementsByClass(className).first();
        
        return resultElement != null ? resultElement.text() : null;
    }
}
