...
while True:
  url = "https://x.x.x.x:5567/protected/clean_project/timestamp/2016-07-01T12:30:00.000/source/eu.dfid.worker.idb.clean.IDBAwardedContractsGoodsAndWorksCleaner/page/%s?auth_token=%s" % (page, token)
...
with open('c:\\tmp\\idb_awarded_contracts_goods_and_works.csv', 'w', newline='', encoding='utf-8') as f:
  writer = csv.writer(f)
